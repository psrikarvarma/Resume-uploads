...
######### output
write_hdl -mapped > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark8/output/FADD_Dual_Main_400MHtz_slow_lvt.v
write_sdc > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark8/output/FADD_Dual_Main_400MHtz_slow_lvt.sdc

# Write results in Report folder
report_timing > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark8/reports/FADD_Dual_Main_400MHtz_slow_lvt_timing.rpt
report_power  > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark8/reports/FADD_Dual_Main_400MHtz_slow_lvt_power.rpt
report_area   > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark8/reports/FADD_Dual_Main_400MHtz_slow_lvt_area.rpt
