...
######### output
write_hdl -mapped > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark8/output/FADD_Dual_Main_400MHtz_slow.v
write_sdc > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark8/output/FADD_Dual_Main_400MHtz_slow.sdc

# Write results in Report folder
report_timing > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark8/reports/FADD_Dual_Main_400MHtz_slow_timing.rpt
report_power  > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark8/reports/FADD_Dual_Main_400MHtz_slow_power.rpt
report_area   > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark8/reports/FADD_Dual_Main_400MHtz_slow_area.rpt
