...
// Generated on: Nov 26 2024 05:46:07 IST (Nov 26 2024 00:16:07 UTC)
...
module uart_rx_fsm_DATA_WIDTH8(CLK, RST, S_DATA, Prescale,
  ...
  INVX1LVT g1428(.A (n_64), .Y (stp_chk_en));
  INVX1LVT g1427(.A (n_61), .Y (par_chk_en));
  INVXLLVT g1429(.A (n_62), .Y (deser_en));
