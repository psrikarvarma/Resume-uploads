...
######### output
write_hdl -mapped > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark9/output/UART_RX_100MHtz_fast_hvt.v
write_sdc > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark9/output/UART_RX_100MHtz_fast_hvt.sdc

# Write results in Report folder
report_timing > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark9/reports/UART_RX_100MHtz_fast_hvt_timing.rpt
report_power  > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark9/reports/UART_RX_100MHtz_fast_hvt_power.rpt
report_area   > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark9/reports/UART_RX_100MHtz_fast_hvt_area.rpt
