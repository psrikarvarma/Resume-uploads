...
// Generated on: Nov 26 2024 05:52:27 IST (Nov 26 2024 00:22:27 UTC)
...
module Serializer_WIDTH8(CLK, RST, DATA, Enable, Busy, Data_Valid,
  ...
  AND3XL g397__2398(.A (ser_count[0]), .B (ser_count[1]), .C
  ...
  DFFRHQX1 \DATA_V_reg[2] (.RN (RST), .CK (CLK), .D (n_22), .Q
       (DATA_V[2]));
  AND2XL g655__5107(.A (n_15), .B (Enable), .Y (n_23));
  ...
  DFFRHQX1 \DATA_V_reg[5] (.RN (RST), .CK (CLK), .D (n_16), .Q
       (DATA_V[5]));
  OAI2BB1X1 g659__6260(.A0N (DATA_V[2]), .A1N (n_3), .B0 (n_11), .Y
       (n_22));
  OAI2BB1X1 g660__4319(.A0N (DATA_V[3]), .A1N (n_3), .B0 (n_7), .Y
       (n_21));
  OAI2BB1X1 g661__8428(.A0N (DATA_V[6]), .A1N (n_3), .B0 (n_12), .Y
       (n_20));
  DFFRHQX1 \DATA_V_reg[7] (.RN (RST), .CK (CLK), .D (n_13), .Q
       (DATA_V[7]));
  DFFRHQX1 \ser_count_reg[1] (.RN (RST), .CK (CLK), .D (n_10), .Q
       (ser_count[1]));
  OAI2BB1X1 g664__5526(.A0N (DATA_V[1]), .A1N (n_3), .B0 (n_6), .Y
       (n_19));
  OAI2BB1X1 g665__6783(.A0N (DATA_V[4]), .A1N (n_3), .B0 (n_8), .Y
       (n_18));
  OAI2BB1X1 g666__3680(.A0N (ser_out), .A1N (n_3), .B0 (n_14), .Y
       (n_17));
  OAI2BB1X1 g667__1617(.A0N (DATA_V[5]), .A1N (n_3), .B0 (n_9), .Y
       (n_16));
  XNOR2X1 g668__2802(.A (ser_count[2]), .B (n_2), .Y (n_15));
  AOI22X1 g669__1705(.A0 (DATA_V[1]), .A1 (n_4), .B0 (DATA[0]), .B1
       (n_1), .Y (n_14));
  AO22XL g670__5122(.A0 (DATA_V[7]), .A1 (n_3), .B0 (DATA[7]), .B1
       (n_1), .Y (n_13));
  AOI22X1 g671__8246(.A0 (DATA_V[7]), .A1 (n_4), .B0 (DATA[6]), .B1
       (n_1), .Y (n_12));
  AOI22X1 g672__7098(.A0 (DATA_V[3]), .A1 (n_4), .B0 (DATA[2]), .B1
       (n_1), .Y (n_11));
  INVX1 g673(.A (n_5), .Y (n_10));
  AOI22X1 g674__6131(.A0 (DATA_V[6]), .A1 (n_4), .B0 (DATA[5]), .B1
       (n_1), .Y (n_9));
  AOI22X1 g675__1881(.A0 (DATA_V[5]), .A1 (n_4), .B0 (DATA[4]), .B1
       (n_1), .Y (n_8));
  AOI22X1 g676__5115(.A0 (DATA_V[4]), .A1 (n_4), .B0 (DATA[3]), .B1
       (n_1), .Y (n_7));
  AOI22X1 g677__7482(.A0 (DATA_V[2]), .A1 (n_4), .B0 (DATA[1]), .B1
       (n_1), .Y (n_6));
  OAI211X1 g678__4733(.A0 (ser_count[1]), .A1 (ser_count[0]), .B0
       (n_2), .C0 (Enable), .Y (n_5));
  DFFRHQX1 \ser_count_reg[0] (.RN (RST), .CK (CLK), .D (n_0), .Q
       (ser_count[0]));
  NOR2BX1 g680__6161(.AN (Enable), .B (n_1), .Y (n_4));
  NOR2X1 g681__9315(.A (n_1), .B (Enable), .Y (n_3));
  NAND2X1 g682__9945(.A (ser_count[1]), .B (ser_count[0]), .Y (n_2));
  NOR2BX1 g683__2883(.AN (Enable), .B (ser_count[0]), .Y (n_0));
  NOR2BX1 g684__2346(.AN (Data_Valid), .B (Busy), .Y (n_1));
endmodule
...
module uart_tx_fsm(CLK, RST, Data_Valid, ser_done, parity_enable,
  ...
  OAI211X1 g408__1666(.A0 (n_6), .A1 (n_7), .B0 (n_14), .C0 (n_17), .Y
       (mux_sel[0]));
  DFFRHQX1 busy_reg(.RN (RST), .CK (CLK), .D (n_9), .Q (busy));
  OR2XL g410__7410(.A (ser_done), .B (n_17), .Y (n_21));
  AOI2BB1X1 g411__6417(.A0N (current_state[1]), .A1N (n_6), .B0
       (current_state[0]), .Y (mux_sel[1]));
  NAND2X1 g412__5477(.A (current_state[1]), .B (n_8), .Y (n_17));
  NAND2BXL g413__2398(.AN (n_8), .B (n_7), .Y (n_9));
  OR3X1 g414__5107(.A (current_state[0]), .B (current_state[2]), .C
       (current_state[1]), .Y (n_14));
  NOR2BX1 g415__6260(.AN (current_state[0]), .B (current_state[2]), .Y
       (n_8));
  NAND2BX1 g416__4319(.AN (current_state[0]), .B (current_state[1]), .Y
       (n_7));
  DFFRHQX1 \current_state_reg[0] (.RN (RST), .CK (CLK), .D (n_5), .Q
       (current_state[0]));
  OAI221X1 g388__8428(.A0 (current_state[1]), .A1 (n_3), .B0 (n_10),
       .B1 (n_14), .C0 (n_21), .Y (n_5));
  OAI32X1 g389__5526(.A0 (parity_enable), .A1 (n_0), .A2 (n_17), .B0
       (n_1), .B1 (n_3), .Y (n_4));
  DFFRHQX1 \current_state_reg[1] (.RN (RST), .CK (CLK), .D (n_2), .Q
       (current_state[1]));
  INVX1 g391(.A (n_3), .Y (n_2));
  NAND2BX1 g392__6783(.AN (current_state[2]), .B (n_14), .Y (n_3));
  NAND2X1 g393__3680(.A (current_state[1]), .B (n_17), .Y (n_1));
...
module mux(CLK, RST, IN_0, IN_1, IN_2, IN_3, SEL, OUT);
  ...
  OAI2BB1X1 g40__1617(.A0N (IN_2), .A1N (SEL[1]), .B0 (n_0), .Y (n_1));
  OAI21X1 g41__2802(.A0 (IN_1), .A1 (SEL[1]), .B0 (SEL[0]), .Y (n_0));
endmodule
...
module parity_calc_WIDTH8(CLK, RST, parity_enable, parity_type, Busy,
  ...
  XNOR2X1 g365__1705(.A (DATA_V[2]), .B (n_7), .Y (n_8));
  XNOR2X1 g366__5122(.A (DATA_V[4]), .B (n_6), .Y (n_7));
  XNOR2X1 g367__8246(.A (DATA_V[0]), .B (n_5), .Y (n_6));
  XNOR2X1 g368__7098(.A (DATA_V[7]), .B (n_4), .Y (n_5));
  XNOR2X1 g369__6131(.A (DATA_V[1]), .B (n_3), .Y (n_4));
  XNOR2X1 g370__1881(.A (DATA_V[6]), .B (n_2), .Y (n_3));
  ...
  XNOR2X1 g375__5115(.A (DATA_V[3]), .B (n_1), .Y (n_2));
  ...
  XNOR2X1 g380__7482(.A (parity_type), .B (DATA_V[5]), .Y (n_1));
  NAND2BX1 g381__4733(.AN (Busy), .B (Data_Valid), .Y (n_0));
endmodule
