...
// Generated on: Nov 26 2024 05:53:04 IST (Nov 26 2024 00:23:04 UTC)
...
module Serializer_WIDTH8(CLK, RST, DATA, Enable, Busy, Data_Valid,
  ...
  OAI2BB1X1 g659__6260(.A0N (DATA_V[2]), .A1N (n_3), .B0 (n_11), .Y
       (n_22));
  OAI2BB1X1 g660__4319(.A0N (DATA_V[4]), .A1N (n_4), .B0 (n_7), .Y
       (n_21));
  ...
  OAI2BB1X1 g664__5526(.A0N (DATA_V[1]), .A1N (n_3), .B0 (n_6), .Y
       (n_19));
  OAI2BB1X1 g665__6783(.A0N (DATA_V[5]), .A1N (n_4), .B0 (n_8), .Y
       (n_18));
  ...
  AOI22X1 g674__6131(.A0 (DATA_V[6]), .A1 (n_4), .B0 (DATA[5]), .B1
       (n_1), .Y (n_9));
  AOI22X1 g675__1881(.A0 (DATA_V[4]), .A1 (n_3), .B0 (DATA[4]), .B1
       (n_1), .Y (n_8));
  AOI22X1 g676__5115(.A0 (DATA_V[3]), .A1 (n_3), .B0 (DATA[3]), .B1
       (n_1), .Y (n_7));
  AOI22X1 g677__7482(.A0 (DATA_V[2]), .A1 (n_4), .B0 (DATA[1]), .B1
       (n_1), .Y (n_6));
  OAI211X1 g678__4733(.A0 (ser_count[0]), .A1 (ser_count[1]), .B0
       (n_2), .C0 (Enable), .Y (n_5));
...
module uart_tx_fsm(CLK, RST, Data_Valid, ser_done, parity_enable,
  ...
  OAI211X1 g436__1666(.A0 (n_6), .A1 (n_7), .B0 (n_14), .C0 (n_17), .Y
       (mux_sel[0]));
  DFFRHQX1 busy_reg(.RN (RST), .CK (CLK), .D (n_9), .Q (busy));
  OR2XL g438__7410(.A (ser_done), .B (n_17), .Y (n_21));
  AOI2BB1X1 g439__6417(.A0N (current_state[1]), .A1N (n_6), .B0
       (current_state[0]), .Y (mux_sel[1]));
  NAND2X1 g440__5477(.A (current_state[1]), .B (n_8), .Y (n_17));
  NAND2BXL g441__2398(.AN (n_8), .B (n_7), .Y (n_9));
  OR3X1 g442__5107(.A (current_state[2]), .B (current_state[1]), .C
       (current_state[0]), .Y (n_14));
  NOR2BX1 g443__6260(.AN (current_state[0]), .B (current_state[2]), .Y
       (n_8));
  NAND2BX1 g444__4319(.AN (current_state[0]), .B (current_state[1]), .Y
       (n_7));
  DFFRHQX1 \current_state_reg[0] (.RN (RST), .CK (CLK), .D (n_5), .Q
       (current_state[0]));
  OAI221X1 g408__8428(.A0 (current_state[1]), .A1 (n_3), .B0 (n_10),
       .B1 (n_14), .C0 (n_21), .Y (n_5));
  OAI32X1 g409__5526(.A0 (parity_enable), .A1 (n_0), .A2 (n_17), .B0
       (n_1), .B1 (n_3), .Y (n_4));
  DFFRHQX1 \current_state_reg[1] (.RN (RST), .CK (CLK), .D (n_2), .Q
       (current_state[1]));
  INVX1 g411(.A (n_3), .Y (n_2));
  NAND2BX1 g412__6783(.AN (current_state[2]), .B (n_14), .Y (n_3));
  NAND2X1 g413__3680(.A (current_state[1]), .B (n_17), .Y (n_1));
...
module parity_calc_WIDTH8(CLK, RST, parity_enable, parity_type, Busy,
  ...
  XNOR2X1 g369__1705(.A (DATA_V[2]), .B (n_7), .Y (n_8));
  XNOR2X1 g370__5122(.A (DATA_V[4]), .B (n_6), .Y (n_7));
  XNOR2X1 g371__8246(.A (DATA_V[0]), .B (n_5), .Y (n_6));
  XNOR2X1 g372__7098(.A (DATA_V[7]), .B (n_4), .Y (n_5));
  XNOR2X1 g373__6131(.A (DATA_V[1]), .B (n_3), .Y (n_4));
  XNOR2X1 g374__1881(.A (DATA_V[6]), .B (n_2), .Y (n_3));
  ...
  XNOR2X1 g379__5115(.A (DATA_V[3]), .B (n_1), .Y (n_2));
  ...
  XNOR2X1 g384__7482(.A (parity_type), .B (DATA_V[5]), .Y (n_1));
  NAND2BX1 g385__4733(.AN (Busy), .B (Data_Valid), .Y (n_0));
endmodule
