...
// Generated on: Nov 26 2024 05:57:09 IST (Nov 26 2024 00:27:09 UTC)
...
module Serializer_WIDTH8(CLK, RST, DATA, Enable, Busy, Data_Valid,
  ...
  AND3XLLVT g389__2398(.A (ser_count[0]), .B (ser_count[2]), .C
  ...
  DFFRHQX1LVT \DATA_V_reg[2] (.RN (RST), .CK (CLK), .D (n_22), .Q
       (DATA_V[2]));
  AND2XLLVT g647__5107(.A (n_12), .B (Enable), .Y (n_23));
  ...
  DFFRHQX1LVT \DATA_V_reg[5] (.RN (RST), .CK (CLK), .D (n_17), .Q
       (DATA_V[5]));
  OAI2BB1X1LVT g651__6260(.A0N (DATA_V[2]), .A1N (n_3), .B0 (n_9), .Y
       (n_22));
  OAI2BB1X1LVT g652__4319(.A0N (DATA_V[3]), .A1N (n_3), .B0 (n_7), .Y
       (n_21));
  OAI2BB1X1LVT g653__8428(.A0N (DATA_V[7]), .A1N (n_4), .B0 (n_11), .Y
       (n_20));
  ...
  AOI222X1LVT g659__5526(.A0 (DATA_V[1]), .A1 (n_3), .B0 (DATA_V[2]),
       .B1 (n_4), .C0 (DATA[1]), .C1 (n_1), .Y (n_16));
  OAI2BB1X1LVT g660__6783(.A0N (DATA_V[5]), .A1N (n_4), .B0 (n_6), .Y
       (n_15));
  AOI222X1LVT g661__3680(.A0 (ser_out), .A1 (n_3), .B0 (DATA_V[1]), .B1
       (n_4), .C0 (DATA[0]), .C1 (n_1), .Y (n_14));
  AOI222X1LVT g662__1617(.A0 (DATA_V[5]), .A1 (n_3), .B0 (DATA_V[6]),
       .B1 (n_4), .C0 (DATA[5]), .C1 (n_1), .Y (n_13));
  XNOR2X1LVT g663__2802(.A (ser_count[2]), .B (n_2), .Y (n_12));
  AOI22XLLVT g664__1705(.A0 (DATA_V[6]), .A1 (n_3), .B0 (DATA[6]), .B1
       (n_1), .Y (n_11));
  AO22XLLVT g665__5122(.A0 (DATA_V[7]), .A1 (n_3), .B0 (DATA[7]), .B1
       (n_1), .Y (n_10));
  AOI22XLLVT g666__8246(.A0 (DATA_V[3]), .A1 (n_4), .B0 (DATA[2]), .B1
       (n_1), .Y (n_9));
  INVXLLVT g667(.A (n_5), .Y (n_8));
  AOI22XLLVT g668__7098(.A0 (DATA_V[4]), .A1 (n_4), .B0 (DATA[3]), .B1
       (n_1), .Y (n_7));
  AOI22XLLVT g669__6131(.A0 (DATA_V[4]), .A1 (n_3), .B0 (DATA[4]), .B1
       (n_1), .Y (n_6));
  OAI211X1LVT g670__1881(.A0 (ser_count[0]), .A1 (ser_count[1]), .B0
       (n_2), .C0 (Enable), .Y (n_5));
  DFFRHQX1LVT \ser_count_reg[0] (.RN (RST), .CK (CLK), .D (n_0), .Q
       (ser_count[0]));
  NOR2BX1LVT g672__5115(.AN (Enable), .B (n_1), .Y (n_4));
  NOR2X1LVT g673__7482(.A (n_1), .B (Enable), .Y (n_3));
  NAND2X1LVT g674__4733(.A (ser_count[1]), .B (ser_count[0]), .Y (n_2));
  NOR2BX1LVT g675__6161(.AN (Enable), .B (ser_count[0]), .Y (n_0));
  NOR2BX1LVT g676__9315(.AN (Data_Valid), .B (Busy), .Y (n_1));
endmodule
...
module uart_tx_fsm(CLK, RST, Data_Valid, ser_done, parity_enable,
  ...
  OAI211X1LVT g412__9945(.A0 (n_6), .A1 (n_7), .B0 (n_13), .C0 (n_16),
       .Y (mux_sel[0]));
  DFFRHQX1LVT busy_reg(.RN (RST), .CK (CLK), .D (n_8), .Q (busy));
  OR2XLLVT g414__2883(.A (ser_done), .B (n_16), .Y (n_20));
  OR3XLLVT g415__2346(.A (current_state[2]), .B (current_state[0]), .C
       (current_state[1]), .Y (n_13));
  NAND3X1LVT g416__1666(.A (current_state[0]), .B (current_state[1]),
       .C (n_6), .Y (n_16));
  ...
  NAND2XLLVT g400__4319(.A (current_state[1]), .B (n_16), .Y (n_1));
