...
// Generated on: Nov 26 2024 05:53:46 IST (Nov 26 2024 00:23:46 UTC)
...
module Serializer_WIDTH8(CLK, RST, DATA, Enable, Busy, Data_Valid,
  ...
  AND3XLHVT g392__2398(.A (ser_count[0]), .B (ser_count[1]), .C
  ...
  DFFRHQX1HVT \DATA_V_reg[2] (.RN (RST), .CK (CLK), .D (n_22), .Q
       (DATA_V[2]));
  AND2XLHVT g650__5107(.A (n_15), .B (Enable), .Y (n_23));
  ...
  DFFRHQX1HVT \DATA_V_reg[5] (.RN (RST), .CK (CLK), .D (n_16), .Q
       (DATA_V[5]));
  OAI2BB1X1HVT g654__6260(.A0N (DATA_V[2]), .A1N (n_3), .B0 (n_11), .Y
       (n_22));
  OAI2BB1X1HVT g655__4319(.A0N (DATA_V[3]), .A1N (n_3), .B0 (n_7), .Y
       (n_21));
  OAI2BB1X1HVT g656__8428(.A0N (DATA_V[6]), .A1N (n_3), .B0 (n_12), .Y
       (n_20));
  DFFRHQX1HVT \DATA_V_reg[7] (.RN (RST), .CK (CLK), .D (n_13), .Q
       (DATA_V[7]));
  DFFRHQX1HVT \ser_count_reg[1] (.RN (RST), .CK (CLK), .D (n_10), .Q
       (ser_count[1]));
  OAI2BB1X1HVT g659__5526(.A0N (DATA_V[1]), .A1N (n_3), .B0 (n_6), .Y
       (n_19));
  OAI2BB1X1HVT g660__6783(.A0N (DATA_V[4]), .A1N (n_3), .B0 (n_8), .Y
       (n_18));
  OAI2BB1X1HVT g661__3680(.A0N (ser_out), .A1N (n_3), .B0 (n_14), .Y
       (n_17));
  OAI2BB1X1HVT g662__1617(.A0N (DATA_V[5]), .A1N (n_3), .B0 (n_9), .Y
       (n_16));
  XNOR2X1HVT g663__2802(.A (ser_count[2]), .B (n_2), .Y (n_15));
  AOI22XLHVT g664__1705(.A0 (DATA_V[1]), .A1 (n_4), .B0 (DATA[0]), .B1
       (n_1), .Y (n_14));
  AO22XLHVT g665__5122(.A0 (DATA_V[7]), .A1 (n_3), .B0 (DATA[7]), .B1
       (n_1), .Y (n_13));
  AOI22XLHVT g666__8246(.A0 (DATA_V[7]), .A1 (n_4), .B0 (DATA[6]), .B1
       (n_1), .Y (n_12));
  AOI22XLHVT g667__7098(.A0 (DATA_V[3]), .A1 (n_4), .B0 (DATA[2]), .B1
       (n_1), .Y (n_11));
  INVXLHVT g668(.A (n_5), .Y (n_10));
  AOI22XLHVT g669__6131(.A0 (DATA_V[6]), .A1 (n_4), .B0 (DATA[5]), .B1
       (n_1), .Y (n_9));
  AOI22XLHVT g670__1881(.A0 (DATA_V[5]), .A1 (n_4), .B0 (DATA[4]), .B1
       (n_1), .Y (n_8));
  AOI22XLHVT g671__5115(.A0 (DATA_V[4]), .A1 (n_4), .B0 (DATA[3]), .B1
       (n_1), .Y (n_7));
  AOI22XLHVT g672__7482(.A0 (DATA_V[2]), .A1 (n_4), .B0 (DATA[1]), .B1
       (n_1), .Y (n_6));
  OAI211X1HVT g673__4733(.A0 (ser_count[0]), .A1 (ser_count[1]), .B0
       (n_2), .C0 (Enable), .Y (n_5));
  DFFRHQX1HVT \ser_count_reg[0] (.RN (RST), .CK (CLK), .D (n_0), .Q
       (ser_count[0]));
  NOR2BX1HVT g675__6161(.AN (Enable), .B (n_1), .Y (n_4));
  NOR2X1HVT g676__9315(.A (n_1), .B (Enable), .Y (n_3));
  NAND2X1HVT g677__9945(.A (ser_count[0]), .B (ser_count[1]), .Y (n_2));
  NOR2BX1HVT g678__2883(.AN (Enable), .B (ser_count[0]), .Y (n_0));
  NOR2BX1HVT g679__2346(.AN (Data_Valid), .B (Busy), .Y (n_1));
endmodule
...
module uart_tx_fsm(CLK, RST, Data_Valid, ser_done, parity_enable,
  ...
  OAI211X1HVT g418__1666(.A0 (n_6), .A1 (n_7), .B0 (n_16), .C0 (n_13),
       .Y (mux_sel[0]));
  DFFRHQX1HVT busy_reg(.RN (RST), .CK (CLK), .D (n_8), .Q (busy));
  OR2XLHVT g420__7410(.A (ser_done), .B (n_16), .Y (n_20));
  OR3XLHVT g421__6417(.A (current_state[0]), .B (current_state[2]), .C
       (current_state[1]), .Y (n_13));
  NAND3X1HVT g422__5477(.A (current_state[1]), .B (current_state[0]),
       .C (n_6), .Y (n_16));
  AOI2BB1X1HVT g423__2398(.A0N (current_state[1]), .A1N (n_6), .B0
       (current_state[0]), .Y (mux_sel[1]));
  OAI2BB1X1HVT g424__5107(.A0N (current_state[0]), .A1N (n_6), .B0
       (n_7), .Y (n_8));
  NAND2BX1HVT g425__6260(.AN (current_state[0]), .B (current_state[1]),
       .Y (n_7));
  DFFRHQX1HVT \current_state_reg[0] (.RN (RST), .CK (CLK), .D (n_5), .Q
       (current_state[0]));
  OAI221X1HVT g391__4319(.A0 (current_state[1]), .A1 (n_2), .B0 (n_9),
       .B1 (n_13), .C0 (n_20), .Y (n_5));
  OAI32X1HVT g392__8428(.A0 (parity_enable), .A1 (n_0), .A2 (n_16), .B0
       (n_1), .B1 (n_2), .Y (n_4));
  DFFRHQX1HVT \current_state_reg[1] (.RN (RST), .CK (CLK), .D (n_3), .Q
       (current_state[1]));
  INVXLHVT g394(.A (n_2), .Y (n_3));
  NAND2BX1HVT g395__5526(.AN (current_state[2]), .B (n_13), .Y (n_2));
  NAND2XLHVT g396__6783(.A (current_state[1]), .B (n_16), .Y (n_1));
...
module parity_calc_WIDTH8(CLK, RST, parity_enable, parity_type, Busy,
  ...
  XNOR2X1HVT g365__2802(.A (DATA_V[2]), .B (n_7), .Y (n_8));
  XNOR2X1HVT g366__1705(.A (DATA_V[4]), .B (n_6), .Y (n_7));
  XNOR2X1HVT g367__5122(.A (DATA_V[0]), .B (n_5), .Y (n_6));
  XNOR2X1HVT g368__8246(.A (DATA_V[7]), .B (n_4), .Y (n_5));
  XNOR2X1HVT g369__7098(.A (DATA_V[1]), .B (n_3), .Y (n_4));
  XNOR2X1HVT g370__6131(.A (DATA_V[6]), .B (n_2), .Y (n_3));
  ...
  XNOR2X1HVT g375__1881(.A (DATA_V[3]), .B (n_1), .Y (n_2));
  ...
  XNOR2X1HVT g380__5115(.A (parity_type), .B (DATA_V[5]), .Y (n_1));
  NAND2BX1HVT g381__7482(.AN (Busy), .B (Data_Valid), .Y (n_0));
endmodule
