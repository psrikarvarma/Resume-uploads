...
# Generated on: Tue Nov 26 11:46:31 IST 2024 (Tue Nov 26 06:16:31 UTC 2024)
...
set_log_file fv/b15/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/b15 -revised fv_map
...
add_search_path /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark5/rtl -design -golden
read_design -rangeconstraint -configuration  -enumconstraint -golden -lastmod -noelab  -vhdl 93  /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark5/rtl/b15.vhd
elaborate_design -golden -root {b15} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/b15/fv_map.v.gz
elaborate_design -revised -root {b15}
...
#add_name_alias fv/b15/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/b15/rtl_to_fv_map.log
}
