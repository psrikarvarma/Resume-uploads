...
# Generated on: Tue Nov 26 12:14:32 IST 2024 (Tue Nov 26 06:44:32 UTC 2024)
...
set_log_file fv/FIR_filter/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/FIR_filter -revised fv_map
...
add_search_path /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark2/rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark2/rtl/FIR_filter.v
elaborate_design -golden -root {FIR_filter} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/FIR_filter/fv_map.v.gz
elaborate_design -revised -root {FIR_filter}
...
#add_name_alias fv/FIR_filter/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/FIR_filter/rtl_to_fv_map.log
}
