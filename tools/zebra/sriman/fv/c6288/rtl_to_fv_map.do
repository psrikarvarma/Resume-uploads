...
# Generated on: Thu Nov 28 11:14:14 IST 2024 (Thu Nov 28 05:44:14 UTC 2024)
...
set_log_file fv/c6288/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/c6288 -revised fv_map
...
read_library -liberty -both /DIG_DESIGN/INTERNS/PDK_DIC/fast_vdd1v0_basicCells_hvt.lib
...
add_search_path /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark3/rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark3/rtl/c6288.v
elaborate_design -golden -root {c6288} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/c6288/fv_map.v.gz
elaborate_design -revised -root {c6288}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/c6288/rtl_to_fv_map.log
}
