...
# Generated on: Tue Nov 26 05:57:08 IST 2024 (Tue Nov 26 00:27:08 UTC 2024)
...
set_log_file fv/UART_TX/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/UART_TX -revised fv_map
...
add_search_path /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark10/rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark10/rtl/mux.v /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark10/rtl/parity_calc.v /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark10/rtl/Serializer.v /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark10/rtl/uart_tx_fsm.v /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark10/rtl/UART_TX.v
elaborate_design -golden -root {UART_TX} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/UART_TX/fv_map.v.gz
elaborate_design -revised -root {UART_TX}
...
#add_name_alias fv/UART_TX/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/UART_TX/rtl_to_fv_map.log
}
