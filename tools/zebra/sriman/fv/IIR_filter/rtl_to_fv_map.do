...
# Generated on: Tue Nov 26 12:57:56 IST 2024 (Tue Nov 26 07:27:56 UTC 2024)
...
set_log_file fv/IIR_filter/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/IIR_filter -revised fv_map
...
add_search_path /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark1/rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark1/rtl/IIR_filter.v
elaborate_design -golden -root {IIR_filter} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/IIR_filter/fv_map.v.gz
elaborate_design -revised -root {IIR_filter}
...
#add_name_alias fv/IIR_filter/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/IIR_filter/rtl_to_fv_map.log
}
