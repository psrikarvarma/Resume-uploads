...
######### output
write_hdl -mapped > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark6/output/UART_400MHtz_fast_lvt.v
write_sdc > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark6/output/UART_400MHtz_fast_lvt.sdc

# Write results in Report folder
report_timing > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark6/reports/UART_400MHtz_fast_lvt_timing.rpt
report_power  > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark6/reports/UART_400MHtz_fast_lvt_power.rpt
report_area   > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark6/reports/UART_400MHtz_fast_lvt_area.rpt
