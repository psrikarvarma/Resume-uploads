...
######### output
write_hdl -mapped > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark6/output/UART_400MHtz_fast.v
write_sdc > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark6/output/UART_400MHtz_fast.sdc

# Write results in Report folder
report_timing > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark6/reports/UART_400MHtz_fast_timing.rpt
report_power  > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark6/reports/UART_400MHtz_fast_power.rpt
report_area   > /DIG_DESIGN/INTERNS/dic_lab_02/sriman/benchmark6/reports/UART_400MHtz_fast_area.rpt
