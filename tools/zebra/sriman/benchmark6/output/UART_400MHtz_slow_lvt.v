...
// Generated on: Nov 26 2024 05:09:30 IST (Nov 25 2024 23:39:30 UTC)
...
module Serializer_WIDTH8(CLK, RST, DATA, Enable, Busy, Data_Valid,
  ...
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16, n_17, n_18, n_19, n_20, n_21, n_22, n_23;
  AND3XLLVT g399__5526(.A (ser_count[0]), .B (ser_count[1]), .C
  ...
  DFFRHQX1LVT \DATA_V_reg[2] (.RN (RST), .CK (CLK), .D (n_22), .Q
       (DATA_V[2]));
  AND2XLLVT g657__6783(.A (n_15), .B (Enable), .Y (n_23));
  ...
  DFFRHQX1LVT \DATA_V_reg[5] (.RN (RST), .CK (CLK), .D (n_16), .Q
       (DATA_V[5]));
  OAI2BB1X1LVT g661__3680(.A0N (n_3), .A1N (DATA_V[2]), .B0 (n_11), .Y
       (n_22));
  OAI2BB1X1LVT g662__1617(.A0N (n_3), .A1N (DATA_V[3]), .B0 (n_7), .Y
       (n_21));
  OAI2BB1X1LVT g663__2802(.A0N (n_3), .A1N (DATA_V[6]), .B0 (n_12), .Y
       (n_20));
  DFFRHQX1LVT \DATA_V_reg[7] (.RN (RST), .CK (CLK), .D (n_13), .Q
       (DATA_V[7]));
  DFFRHQX1LVT \ser_count_reg[1] (.RN (RST), .CK (CLK), .D (n_10), .Q
       (ser_count[1]));
  OAI2BB1X1LVT g666__1705(.A0N (n_3), .A1N (DATA_V[1]), .B0 (n_6), .Y
       (n_19));
  OAI2BB1X1LVT g667__5122(.A0N (n_3), .A1N (DATA_V[4]), .B0 (n_8), .Y
       (n_18));
  OAI2BB1X1LVT g668__8246(.A0N (n_3), .A1N (ser_out), .B0 (n_14), .Y
       (n_17));
  OAI2BB1X1LVT g669__7098(.A0N (n_3), .A1N (DATA_V[5]), .B0 (n_9), .Y
       (n_16));
  XNOR2X1LVT g670__6131(.A (ser_count[2]), .B (n_2), .Y (n_15));
  AOI22X1LVT g671__1881(.A0 (n_4), .A1 (DATA_V[1]), .B0 (DATA[0]), .B1
       (n_1), .Y (n_14));
  AO22XLLVT g672__5115(.A0 (n_3), .A1 (DATA_V[7]), .B0 (DATA[7]), .B1
       (n_1), .Y (n_13));
  AOI22X1LVT g673__7482(.A0 (n_4), .A1 (DATA_V[7]), .B0 (DATA[6]), .B1
       (n_1), .Y (n_12));
  AOI22X1LVT g674__4733(.A0 (n_4), .A1 (DATA_V[3]), .B0 (DATA[2]), .B1
       (n_1), .Y (n_11));
  INVXLLVT g675(.A (n_5), .Y (n_10));
  AOI22X1LVT g676__6161(.A0 (n_4), .A1 (DATA_V[6]), .B0 (DATA[5]), .B1
       (n_1), .Y (n_9));
  AOI22X1LVT g677__9315(.A0 (n_4), .A1 (DATA_V[5]), .B0 (DATA[4]), .B1
       (n_1), .Y (n_8));
  AOI22X1LVT g678__9945(.A0 (n_4), .A1 (DATA_V[4]), .B0 (DATA[3]), .B1
       (n_1), .Y (n_7));
  AOI22X1LVT g679__2883(.A0 (n_4), .A1 (DATA_V[2]), .B0 (DATA[1]), .B1
       (n_1), .Y (n_6));
  OAI211X1LVT g680__2346(.A0 (ser_count[1]), .A1 (ser_count[0]), .B0
       (n_2), .C0 (Enable), .Y (n_5));
  DFFRHQX1LVT \ser_count_reg[0] (.RN (RST), .CK (CLK), .D (n_0), .Q
       (ser_count[0]));
  NOR2BX1LVT g682__1666(.AN (Enable), .B (n_1), .Y (n_4));
  NOR2X1LVT g683__7410(.A (n_1), .B (Enable), .Y (n_3));
  NAND2X1LVT g684__6417(.A (ser_count[1]), .B (ser_count[0]), .Y (n_2));
  NOR2BX1LVT g685__5477(.AN (Enable), .B (ser_count[0]), .Y (n_0));
  NOR2BX1LVT g686__2398(.AN (Data_Valid), .B (Busy), .Y (n_1));
endmodule
...
module uart_tx_fsm(CLK, RST, Data_Valid, ser_done, parity_enable,
  ...
  OAI211X1LVT g408__5107(.A0 (n_6), .A1 (n_7), .B0 (n_14), .C0 (n_17),
       .Y (mux_sel[0]));
  DFFRHQX1LVT busy_reg(.RN (RST), .CK (CLK), .D (n_9), .Q (busy));
  OR2XLLVT g410__6260(.A (ser_done), .B (n_17), .Y (n_21));
  AOI2BB1X1LVT g411__4319(.A0N (current_state[1]), .A1N (n_6), .B0
       (current_state[0]), .Y (mux_sel[1]));
  NAND2X1LVT g412__8428(.A (current_state[1]), .B (n_8), .Y (n_17));
  NAND2BXLLVT g413__5526(.AN (n_8), .B (n_7), .Y (n_9));
  OR3XLLVT g414__6783(.A (current_state[0]), .B (current_state[2]), .C
       (current_state[1]), .Y (n_14));
  NOR2BX1LVT g415__3680(.AN (current_state[0]), .B (current_state[2]),
       .Y (n_8));
  NAND2BX1LVT g416__1617(.AN (current_state[0]), .B (current_state[1]),
       .Y (n_7));
  DFFRHQX1LVT \current_state_reg[0] (.RN (RST), .CK (CLK), .D (n_5), .Q
       (current_state[0]));
  OAI221X1LVT g388__2802(.A0 (current_state[1]), .A1 (n_2), .B0 (n_10),
       .B1 (n_14), .C0 (n_21), .Y (n_5));
  OAI32X1LVT g389__1705(.A0 (parity_enable), .A1 (n_0), .A2 (n_17), .B0
       (n_1), .B1 (n_2), .Y (n_4));
  DFFRHQX1LVT \current_state_reg[1] (.RN (RST), .CK (CLK), .D (n_3), .Q
       (current_state[1]));
  INVXLLVT g391(.A (n_2), .Y (n_3));
  NAND2BX1LVT g392__5122(.AN (current_state[2]), .B (n_14), .Y (n_2));
  NAND2X1LVT g393__8246(.A (current_state[1]), .B (n_17), .Y (n_1));
...
module mux(CLK, RST, IN_0, IN_1, IN_2, IN_3, SEL, OUT);
  ...
  OAI2BB1X1LVT g40__7098(.A0N (IN_2), .A1N (SEL[1]), .B0 (n_0), .Y
       (n_1));
  OAI21X1LVT g41__6131(.A0 (IN_1), .A1 (SEL[1]), .B0 (SEL[0]), .Y
       (n_0));
endmodule
...
module parity_calc_WIDTH8(CLK, RST, parity_enable, parity_type, Busy,
  ...
  XNOR2X1LVT g365__1881(.A (n_7), .B (DATA_V[2]), .Y (n_8));
  XNOR2X1LVT g366__5115(.A (n_6), .B (DATA_V[4]), .Y (n_7));
  XNOR2X1LVT g367__7482(.A (n_5), .B (DATA_V[0]), .Y (n_6));
  XNOR2X1LVT g368__4733(.A (n_4), .B (DATA_V[7]), .Y (n_5));
  XNOR2X1LVT g369__6161(.A (n_3), .B (DATA_V[1]), .Y (n_4));
  XNOR2X1LVT g370__9315(.A (n_2), .B (DATA_V[6]), .Y (n_3));
  ...
  XNOR2X1LVT g375__9945(.A (n_1), .B (DATA_V[3]), .Y (n_2));
  ...
  XNOR2X1LVT g380__2883(.A (parity_type), .B (DATA_V[5]), .Y (n_1));
  NAND2BX1LVT g381__2346(.AN (Busy), .B (Data_Valid), .Y (n_0));
endmodule
