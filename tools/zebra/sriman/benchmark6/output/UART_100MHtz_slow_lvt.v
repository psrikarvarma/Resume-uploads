...
// Generated on: Nov 26 2024 05:03:12 IST (Nov 25 2024 23:33:12 UTC)
...
module data_sampling(CLK, RST, S_DATA, Prescale, edge_count, Enable,
  ...
  NOR4X1LVT g1610__5122(.A (n_5), .B (n_4), .C (n_30), .D
       (edge_count[5]), .Y (n_31));
...
module deserializer_DATA_WIDTH8(CLK, RST, sampled_bit, Enable,
  ...
  OR4X1LVT g619__7098(.A (n_12), .B (n_15), .C (n_18), .D (n_0), .Y
       (n_19));
  OAI221X1LVT g620__6131(.A0 (n_9), .A1 (edge_count[5]), .B0
       (Prescale[0]), .B1 (edge_count[0]), .C0 (n_17), .Y (n_18));
  AOI21X1LVT g621__1881(.A0 (n_9), .A1 (edge_count[5]), .B0 (n_16), .Y
       (n_17));
  OAI211X1LVT g622__5115(.A0 (n_3), .A1 (edge_count[1]), .B0 (n_8), .C0
       (n_14), .Y (n_16));
  XNOR2X1LVT g623__7482(.A (n_13), .B (edge_count[4]), .Y (n_15));
  AOI221X1LVT g624__4733(.A0 (n_10), .A1 (edge_count[2]), .B0
       (Prescale[0]), .B1 (edge_count[0]), .C0 (n_11), .Y (n_14));
  AOI21XLLVT g625__6161(.A0 (Prescale[4]), .A1 (n_6), .B0 (n_5), .Y
       (n_13));
  XNOR2X1LVT g626__9315(.A (n_7), .B (edge_count[3]), .Y (n_12));
...
module edge_bit_counter(CLK, RST, Enable, Prescale, bit_count,
  ...
  DFFRHQX1LVT \bit_count_reg[3] (.RN (RST), .CK (CLK), .D (n_52), .Q
       (bit_count[3]));
  OAI21XLLVT g1297__4319(.A0 (n_39), .A1 (n_21), .B0 (n_49), .Y (n_52));
  OAI31X1LVT g1298__8428(.A0 (n_39), .A1 (bit_count[2]), .A2 (n_6), .B0
       (n_50), .Y (n_51));
  NAND2X1LVT g1301__5526(.A (n_48), .B (bit_count[2]), .Y (n_50));
  NAND2X1LVT g1302__6783(.A (n_48), .B (bit_count[3]), .Y (n_49));
  ...
  DFFRHQX1LVT \edge_count_reg[3] (.RN (RST), .CK (CLK), .D (n_44), .Q
       (edge_count[3]));
  AND2XLLVT g1308__3680(.A (n_36), .B (n_40), .Y (n_47));
  OAI22X1LVT g1309__1617(.A0 (n_39), .A1 (n_9), .B0 (n_37), .B1 (n_1),
       .Y (n_46));
  OAI2BB1X1LVT g1310__2802(.A0N (n_38), .A1N (n_6), .B0 (n_37), .Y
       (n_48));
  NOR2X1LVT g1312__1705(.A (n_37), .B (edge_count[0]), .Y (n_45));
  NOR2X1LVT g1313__5122(.A (n_37), .B (n_29), .Y (n_44));
  NOR2X1LVT g1314__8246(.A (n_37), .B (n_20), .Y (n_43));
  NOR2X1LVT g1315__7098(.A (n_37), .B (n_33), .Y (n_42));
  NOR2X1LVT g1316__6131(.A (n_37), .B (n_11), .Y (n_41));
  ...
  AOI221X1LVT g1322__4733(.A0 (n_23), .A1 (edge_count[3]), .B0 (n_14),
       .B1 (edge_count[2]), .C0 (n_34), .Y (n_35));
  OAI221X1LVT g1323__6161(.A0 (n_26), .A1 (n_2), .B0 (n_23), .B1
  ...
  AOI221X1LVT g1326__2883(.A0 (n_26), .A1 (n_2), .B0 (n_8), .B1 (n_0),
       .C0 (n_30), .Y (n_31));
  OAI211X1LVT g1327__2346(.A0 (n_17), .A1 (edge_count[4]), .B0 (n_27),
       .C0 (n_24), .Y (n_30));
  ...
  OAI221X1LVT g1331__6417(.A0 (n_14), .A1 (edge_count[2]), .B0
       (Prescale[0]), .B1 (n_18), .C0 (n_22), .Y (n_25));
  XNOR2X1LVT g1332__5477(.A (Prescale[5]), .B (n_15), .Y (n_26));
  NAND2XLLVT g1333__2398(.A (n_17), .B (edge_count[4]), .Y (n_24));
  AOI21XLLVT g1334__5107(.A0 (Prescale[3]), .A1 (n_12), .B0 (n_13), .Y
       (n_23));
  OAI21X1LVT g1335__6260(.A0 (n_10), .A1 (edge_count[0]), .B0
       (Prescale[0]), .Y (n_22));
  AOI21X1LVT g1336__4319(.A0 (bit_count[3]), .A1 (n_5), .B0 (n_16), .Y
       (n_21));
  XNOR2X1LVT g1337__8428(.A (edge_count[2]), .B (n_7), .Y (n_20));
  AOI21X1LVT g1338__5526(.A0 (Prescale[1]), .A1 (edge_count[1]), .B0
       (n_4), .Y (n_18));
  AND2XLLVT g1339__6783(.A (edge_count[2]), .B (n_7), .Y (n_19));
  NOR3X1LVT g1340__3680(.A (bit_count[3]), .B (n_5), .C (n_6), .Y
       (n_16));
...
module par_chk_DATA_WIDTH8(CLK, RST, parity_type, sampled_bit, Enable,
  ...
  XNOR2X1LVT g170__6417(.A (parity_type), .B (sampled_bit), .Y (n_1));
...
module uart_rx_fsm_DATA_WIDTH8(CLK, RST, S_DATA, Prescale,
  ...
  INVX1LVT g1429(.A (n_64), .Y (stp_chk_en));
  INVXLLVT g1427(.A (n_62), .Y (deser_en));
  INVX1LVT g1428(.A (n_61), .Y (par_chk_en));
  NAND2X1LVT g1565__2398(.A (n_57), .B (n_55), .Y (edge_bit_en));
  NAND2BX1LVT g1566__5107(.AN (current_state[1]), .B (n_57), .Y
       (dat_samp_en));
  NAND2X1LVT g1567__6260(.A (n_66), .B (n_65), .Y (strt_chk_en));
  AOI21X1LVT g1568__4319(.A0 (current_state[0]), .A1 (n_1), .B0 (n_56),
       .Y (n_57));
  INVX1LVT g1569(.A (n_56), .Y (n_66));
  NOR4X1LVT g1570__8428(.A (S_DATA), .B (current_state[1]), .C
       (current_state[2]), .D (current_state[0]), .Y (n_56));
  NOR4X1LVT g1571__5526(.A (par_err), .B (stp_err), .C (n_1), .D
       (n_63), .Y (data_valid));
  OR2X1LVT g1572__6783(.A (current_state[2]), .B (n_63), .Y (n_62));
  NAND3BXLLVT g1573__3680(.AN (current_state[1]), .B
       (current_state[0]), .C (n_1), .Y (n_65));
  OR2X1LVT g1574__1617(.A (n_1), .B (n_55), .Y (n_64));
  OR2X1LVT g1575__2802(.A (current_state[2]), .B (n_55), .Y (n_61));
  NAND2X1LVT g1576__1705(.A (current_state[1]), .B (current_state[0]),
       .Y (n_63));
  NAND2BX1LVT g1577__5122(.AN (current_state[0]), .B
  ...
  DFFRHQX1LVT \current_state_reg[0] (.RN (RST), .CK (CLK), .D (n_52),
       .Q (current_state[0]));
  NAND4XLLVT g2487__8246(.A (n_48), .B (n_62), .C (n_61), .D (n_64), .Y
       (n_53));
  OAI221X1LVT g2488__7098(.A0 (n_44), .A1 (n_63), .B0 (n_37), .B1
       (n_64), .C0 (n_51), .Y (n_52));
  NOR2BX1LVT g2490__6131(.AN (n_66), .B (n_49), .Y (n_51));
  NAND2BXLLVT g2491__1881(.AN (n_47), .B (n_64), .Y (n_50));
  AOI21X1LVT g2492__5115(.A0 (n_46), .A1 (strt_glitch), .B0 (n_65), .Y
       (n_49));
  OR3XLLVT g2493__7482(.A (n_45), .B (strt_glitch), .C (n_65), .Y
       (n_48));
  OAI33X1LVT g2494__4733(.A0 (parity_enable), .A1 (n_42), .A2 (n_62),
       .B0 (n_3), .B1 (n_40), .B2 (n_61), .Y (n_47));
  INVXLLVT g2495(.A (n_45), .Y (n_46));
  NAND2X1LVT g2496__6161(.A (n_43), .B (n_3), .Y (n_45));
  OA22X1LVT g2497__9315(.A0 (n_41), .A1 (n_62), .B0 (S_DATA), .B1
       (n_1), .Y (n_44));
  NOR4X1LVT g2498__9945(.A (n_39), .B (bit_count[1]), .C
       (bit_count[3]), .D (bit_count[2]), .Y (n_43));
  INVXLLVT g2499(.A (n_41), .Y (n_42));
  NOR2X1LVT g2500__2883(.A (n_40), .B (bit_count[0]), .Y (n_41));
  NAND2BX1LVT g2501__2346(.AN (n_39), .B (n_10), .Y (n_40));
  OAI211X1LVT g2502__1666(.A0 (Prescale[0]), .A1 (n_7), .B0 (n_8), .C0
       (n_38), .Y (n_39));
  AOI211XLLVT g2503__7410(.A0 (Prescale[0]), .A1 (n_7), .B0 (n_27), .C0
       (n_36), .Y (n_38));
  OAI211X1LVT g2504__6417(.A0 (n_31), .A1 (edge_count[5]), .B0 (n_35),
       .C0 (n_34), .Y (n_37));
  OAI211X1LVT g2505__5477(.A0 (n_17), .A1 (edge_count[2]), .B0 (n_22),
       .C0 (n_33), .Y (n_36));
  AOI22X1LVT g2506__2398(.A0 (n_31), .A1 (edge_count[5]), .B0
       (parity_enable), .B1 (n_11), .Y (n_35));
  NOR4X1LVT g2507__5107(.A (n_12), .B (n_16), .C (n_32), .D (n_29), .Y
       (n_34));
  AOI221X1LVT g2508__6260(.A0 (n_25), .A1 (edge_count[5]), .B0 (n_28),
       .B1 (edge_count[4]), .C0 (n_30), .Y (n_33));
  XNOR2X1LVT g2509__4319(.A (n_26), .B (edge_count[4]), .Y (n_32));
  OAI22X1LVT g2510__8428(.A0 (n_25), .A1 (edge_count[5]), .B0 (n_28),
       .B1 (edge_count[4]), .Y (n_30));
  XNOR2X1LVT g2511__5526(.A (Prescale[5]), .B (n_23), .Y (n_31));
  NAND3BXLLVT g2512__6783(.AN (n_8), .B (n_7), .C (n_24), .Y (n_29));
  AOI21XLLVT g2513__3680(.A0 (Prescale[4]), .A1 (n_19), .B0 (n_21), .Y
       (n_28));
  XNOR2X1LVT g2514__1617(.A (n_20), .B (edge_count[3]), .Y (n_27));
  AOI21XLLVT g2515__2802(.A0 (Prescale[4]), .A1 (n_14), .B0 (n_23), .Y
       (n_26));
  XNOR2X1LVT g2516__1705(.A (n_15), .B (edge_count[3]), .Y (n_24));
  XNOR2X1LVT g2517__5122(.A (Prescale[5]), .B (n_21), .Y (n_25));
  NOR2XLLVT g2518__8246(.A (Prescale[4]), .B (n_14), .Y (n_23));
  NAND2XLLVT g2519__7098(.A (n_17), .B (edge_count[2]), .Y (n_22));
  AOI21XLLVT g2520__6131(.A0 (Prescale[3]), .A1 (n_13), .B0 (n_18), .Y
       (n_20));
  NOR3XLLVT g2521__1881(.A (Prescale[4]), .B (Prescale[3]), .C (n_13),
       .Y (n_21));
  INVXLLVT g2522(.A (n_18), .Y (n_19));
  NOR2XLLVT g2523__5115(.A (Prescale[3]), .B (n_13), .Y (n_18));
  AND2X1LVT g2524__7482(.A (n_13), .B (n_9), .Y (n_17));
  XNOR2X1LVT g2525__4733(.A (n_6), .B (edge_count[2]), .Y (n_16));
  OAI21XLLVT g2526__6161(.A0 (n_0), .A1 (n_4), .B0 (n_14), .Y (n_15));
  NAND2XLLVT g2527__9315(.A (n_0), .B (n_4), .Y (n_14));
  AOI21X1LVT g2528__9945(.A0 (bit_count[0]), .A1 (n_10), .B0
       (parity_enable), .Y (n_12));
  NAND2XLLVT g2529__2883(.A (n_2), .B (n_4), .Y (n_13));
  NAND3X1LVT g2530__2346(.A (bit_count[1]), .B (n_3), .C (n_5), .Y
       (n_11));
  OAI21XLLVT g2531__1666(.A0 (Prescale[0]), .A1 (Prescale[1]), .B0
       (Prescale[2]), .Y (n_9));
  NOR2BX1LVT g2532__7410(.AN (n_5), .B (bit_count[1]), .Y (n_10));
  AOI21XLLVT g2533__6417(.A0 (Prescale[1]), .A1 (Prescale[2]), .B0
       (n_4), .Y (n_6));
  MXI2XLLVT g2534__5477(.A (n_2), .B (Prescale[0]), .S0
       (edge_count[0]), .Y (n_8));
  CLKXOR2X1LVT g2535__2398(.A (Prescale[1]), .B (edge_count[1]), .Y
       (n_7));
  NOR2BX1LVT g2536__5107(.AN (bit_count[3]), .B (bit_count[2]), .Y
       (n_5));
  NOR2XLLVT g2537__6260(.A (Prescale[1]), .B (Prescale[2]), .Y (n_4));
  INVX1LVT g2538(.A (bit_count[0]), .Y (n_3));
  INVXLLVT g2539(.A (Prescale[0]), .Y (n_2));
  INVXLLVT g2541(.A (Prescale[3]), .Y (n_0));
...
module Serializer_WIDTH8(CLK, RST, DATA, Enable, Busy, Data_Valid,
  ...
  wire n_8, n_9, n_10, n_11, n_12, n_13, n_14, n_15;
  wire n_16, n_17, n_18, n_19, n_20, n_21, n_22, n_23;
  AND3XLLVT g407__4319(.A (ser_count[0]), .B (ser_count[1]), .C
  ...
  DFFRHQX1LVT \DATA_V_reg[2] (.RN (RST), .CK (CLK), .D (n_22), .Q
       (DATA_V[2]));
  AND2XLLVT g665__8428(.A (n_12), .B (Enable), .Y (n_23));
  ...
  DFFRHQX1LVT \DATA_V_reg[5] (.RN (RST), .CK (CLK), .D (n_13), .Q
       (DATA_V[5]));
  OAI2BB1X1LVT g669__5526(.A0N (n_4), .A1N (DATA_V[3]), .B0 (n_9), .Y
       (n_22));
  OAI2BB1X1LVT g670__6783(.A0N (n_3), .A1N (DATA_V[3]), .B0 (n_7), .Y
       (n_21));
  OAI2BB1X1LVT g671__3680(.A0N (n_3), .A1N (DATA_V[6]), .B0 (n_11), .Y
       (n_20));
  ...
  AOI222X1LVT g677__1617(.A0 (n_3), .A1 (DATA_V[1]), .B0 (n_4), .B1
       (DATA_V[2]), .C0 (DATA[1]), .C1 (n_1), .Y (n_16));
  AOI222X1LVT g678__2802(.A0 (n_3), .A1 (DATA_V[4]), .B0 (n_4), .B1
       (DATA_V[5]), .C0 (DATA[4]), .C1 (n_1), .Y (n_15));
  AOI222X1LVT g679__1705(.A0 (n_3), .A1 (ser_out), .B0 (n_4), .B1
       (DATA_V[1]), .C0 (DATA[0]), .C1 (n_1), .Y (n_14));
  OAI2BB1X1LVT g680__5122(.A0N (n_4), .A1N (DATA_V[6]), .B0 (n_6), .Y
       (n_13));
  XNOR2X1LVT g681__8246(.A (ser_count[2]), .B (n_2), .Y (n_12));
  AOI22X1LVT g682__7098(.A0 (n_4), .A1 (DATA_V[7]), .B0 (DATA[6]), .B1
       (n_1), .Y (n_11));
  AO22XLLVT g683__6131(.A0 (n_3), .A1 (DATA_V[7]), .B0 (DATA[7]), .B1
       (n_1), .Y (n_10));
  AOI22X1LVT g684__1881(.A0 (n_3), .A1 (DATA_V[2]), .B0 (DATA[2]), .B1
       (n_1), .Y (n_9));
  INVXLLVT g685(.A (n_5), .Y (n_8));
  AOI22X1LVT g686__5115(.A0 (n_4), .A1 (DATA_V[4]), .B0 (DATA[3]), .B1
       (n_1), .Y (n_7));
  AOI22X1LVT g687__7482(.A0 (n_3), .A1 (DATA_V[5]), .B0 (DATA[5]), .B1
       (n_1), .Y (n_6));
  OAI211X1LVT g688__4733(.A0 (ser_count[0]), .A1 (ser_count[1]), .B0
       (n_2), .C0 (Enable), .Y (n_5));
  DFFRHQX1LVT \ser_count_reg[0] (.RN (RST), .CK (CLK), .D (n_0), .Q
       (ser_count[0]));
  NOR2BX1LVT g690__6161(.AN (Enable), .B (n_1), .Y (n_4));
  NOR2X1LVT g691__9315(.A (n_1), .B (Enable), .Y (n_3));
  NAND2X1LVT g692__9945(.A (ser_count[0]), .B (ser_count[1]), .Y (n_2));
  NOR2BX1LVT g693__2883(.AN (Enable), .B (ser_count[0]), .Y (n_0));
  NOR2BX1LVT g694__2346(.AN (Data_Valid), .B (Busy), .Y (n_1));
endmodule
...
module uart_tx_fsm(CLK, RST, Data_Valid, ser_done, parity_enable,
  ...
  OAI211X1LVT g412__1666(.A0 (n_6), .A1 (n_7), .B0 (n_16), .C0 (n_13),
       .Y (mux_sel[0]));
  DFFRHQX1LVT busy_reg(.RN (RST), .CK (CLK), .D (n_8), .Q (busy));
  OR2XLLVT g414__7410(.A (ser_done), .B (n_16), .Y (n_20));
  OR3XLLVT g415__6417(.A (current_state[1]), .B (current_state[0]), .C
       (current_state[2]), .Y (n_13));
  NAND3X1LVT g416__5477(.A (current_state[1]), .B (current_state[0]),
       .C (n_6), .Y (n_16));
  AOI2BB1X1LVT g417__2398(.A0N (current_state[1]), .A1N (n_6), .B0
       (current_state[0]), .Y (mux_sel[1]));
  OAI2BB1X1LVT g418__5107(.A0N (current_state[0]), .A1N (n_6), .B0
       (n_7), .Y (n_8));
  NAND2BX1LVT g419__6260(.AN (current_state[0]), .B (current_state[1]),
       .Y (n_7));
  DFFRHQX1LVT \current_state_reg[0] (.RN (RST), .CK (CLK), .D (n_5), .Q
       (current_state[0]));
  OAI221X1LVT g395__4319(.A0 (current_state[1]), .A1 (n_2), .B0 (n_9),
       .B1 (n_13), .C0 (n_20), .Y (n_5));
  OAI32X1LVT g396__8428(.A0 (parity_enable), .A1 (n_0), .A2 (n_16), .B0
       (n_1), .B1 (n_2), .Y (n_4));
  DFFRHQX1LVT \current_state_reg[1] (.RN (RST), .CK (CLK), .D (n_3), .Q
       (current_state[1]));
  INVXLLVT g398(.A (n_2), .Y (n_3));
  NAND2BX1LVT g399__5526(.AN (current_state[2]), .B (n_13), .Y (n_2));
  NAND2X1LVT g400__6783(.A (current_state[1]), .B (n_16), .Y (n_1));
...
module mux(CLK, RST, IN_0, IN_1, IN_2, IN_3, SEL, OUT);
  ...
  OAI2BB1X1LVT g40__3680(.A0N (IN_2), .A1N (SEL[1]), .B0 (n_0), .Y
       (n_1));
  OAI21X1LVT g41__1617(.A0 (IN_1), .A1 (SEL[1]), .B0 (SEL[0]), .Y
       (n_0));
endmodule
...
module parity_calc_WIDTH8(CLK, RST, parity_enable, parity_type, Busy,
  ...
  XNOR2X1LVT g369__2802(.A (n_7), .B (DATA_V[2]), .Y (n_8));
  XNOR2X1LVT g370__1705(.A (n_6), .B (DATA_V[4]), .Y (n_7));
  XNOR2X1LVT g371__5122(.A (n_5), .B (DATA_V[0]), .Y (n_6));
  XNOR2X1LVT g372__8246(.A (n_4), .B (DATA_V[7]), .Y (n_5));
  XNOR2X1LVT g373__7098(.A (n_3), .B (DATA_V[1]), .Y (n_4));
  XNOR2X1LVT g374__6131(.A (n_2), .B (DATA_V[6]), .Y (n_3));
  ...
  XNOR2X1LVT g379__1881(.A (n_1), .B (DATA_V[3]), .Y (n_2));
  ...
  XNOR2X1LVT g384__5115(.A (parity_type), .B (DATA_V[5]), .Y (n_1));
  NAND2BX1LVT g385__7482(.AN (Busy), .B (Data_Valid), .Y (n_0));
endmodule
