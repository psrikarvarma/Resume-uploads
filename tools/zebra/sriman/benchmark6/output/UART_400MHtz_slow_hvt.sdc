...
#  Created by Genus(TM) Synthesis Solution 20.10-p001_1 on Tue Nov 26 05:08:42 IST 2024
...
create_clock -name "TX_CLK" -period 2.5 -waveform {0.0 1.25} [get_ports TX_CLK]
set_clock_transition 0.1 [get_clocks TX_CLK]
create_clock -name "RX_CLK" -period 2.5 -waveform {0.0 1.25} [get_ports RX_CLK]
